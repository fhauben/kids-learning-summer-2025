...
import { Globe, MapPin, Flag, Target, Award, Sparkles, Users, Calendar } from 'lucide-react';
...
const countries: Country[] = [
  ...
  },
  {
    ...
    landmarks: ['Matterhorn', 'Lake Geneva', 'Château de Chillon'],
  ...
  },
  {
    ...
    landmarks: ['Vaduz Castle', 'Liechtenstein National Museum', 'Gutenberg Castle'],
    languages: ['German']
  },
  {
    name: 'Greece',
    ...
    landmarks: ['Parthenon', 'Santorini', 'Acropolis'],
    languages: ['Greek']
  },
  {
    name: 'Austria',
    ...
    landmarks: ['Schönbrunn Palace', 'Hofburg Palace', 'Salzburg Old Town'],
    languages: ['German']
  },
  {
    name: 'Italy',
  ...
  },
  {
    ...
    landmarks: ['Flame Towers', 'Old City of Baku', 'Gobustan Rock Art'],
  ...
  },
  {
    ...
    landmarks: ['Victoria Falls', 'Great Zimbabwe Ruins', 'Hwange National Park'],
  ...
  },
  {
    ...
    landmarks: ['Galápagos Islands', 'Cotopaxi Volcano', 'Historic Center of Quito'],
    languages: ['Spanish']
  },
  {
    name: 'South Korea',
    ...
    landmarks: ['Gyeongbokgung Palace', 'N Seoul Tower', 'Jeju Island'],
    languages: ['Korean']
  },
  {
    name: 'Taiwan',
  ...
  },
  {
    ...
    landmarks: ['Ha Long Bay', 'Hoi An Ancient Town', 'Cu Chi Tunnels'],
  ...
  },
  {
    ...
    landmarks: ['Little Mermaid Statue', 'Tivoli Gardens', 'Nyhavn Harbor'],
    languages: ['Danish']
  },
  {
    name: 'Norway',
    ...
    landmarks: ['Northern Lights', 'Geirangerfjord', 'Vigeland Sculpture Park'],
    languages: ['Norwegian']
  },
  {
    name: 'Sweden',
    ...
    landmarks: ['Vasa Museum', 'Gamla Stan', 'ABBA Museum'],
    languages: ['Swedish']
  },
  {
    name: 'Mexico',
    ...
    landmarks: ['Chichen Itza', 'Teotihuacan', 'Tulum'],
    languages: ['Spanish']
  },
  {
    name: 'Canada',
...
const CountriesQuiz: React.FC<CountriesQuizProps> = ({ onBack, onSaveProgress }) => {
  ...
  const [quizMode, setQuizMode] = useState<'capital' | 'flag' | 'fact'>('capital');
  ...
  const questions = [
    ...
    },
    {
      ...
      options: ['Azerbaijan', 'Iran', 'Iraq', 'Turkey'],
      correct: 0,
      country: countries.find(c => c.name === 'Azerbaijan')!
    },
    {
      type: 'capital' as const,
    ...
    },
    {
      ...
      correct: 1,
      country: countries.find(c => c.name === 'Vietnam')!
    },
    {
      type: 'capital' as const,
    ...
    },
    {
      ...
      correct: 1,
      country: countries.find(c => c.name === 'Sweden')!
    },
    {
      type: 'fact' as const,
    ...
    {
      type: 'fact' as const,
      question: 'Which country has the world\'s largest cave?',
    ...
    {
      type: 'fact' as const,
      question: 'Which country has the world\'s longest road tunnel?',
    ...
    {
      type: 'fact' as const,
      question: 'Which country has the world\'s largest furniture store?',
      options: ['Norway', 'Denmark', 'Sweden', 'Finland'],
      correct: 2,
      country: countries.find(c => c.name === 'Sweden')!
    },
    ...
    {
      type: 'fact' as const,
      question: 'Which country introduced chocolate to the world?',
      options: ['Belgium', 'Switzerland', 'Mexico', 'Brazil'],
      correct: 2,
      country: countries.find(c => c.name === 'Mexico')!
    }
  ];
  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-700 text-lg">Test your knowledge of countries, capitals, flags, and fun facts from around the world!</p>
      </div>
      ...
      {!showResults ? (
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="text-center mb-8">
            ...
            {currentQ.type === 'flag' && (
              <div className="text-6xl mb-4">{currentQ.question.split('🇫🇷')[1] || currentQ.question.split('🇦🇺')[1] || currentQ.question.split('🇮🇳')[1]}</div>
            )}
          </div>
              ...
              <div className="flex items-start">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid md:grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      <strong>Population:</strong> {currentQ.country.population}
                    </div>
                    <div>
                      <strong>Languages:</strong> {currentQ.country.languages.join(', ')}
                    </div>
                  </div>
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    <strong>Languages:</strong> {selectedCountry.languages.join(', ')}
                  </div>
                </div>
                ...
                <div className="bg-green-50 rounded-lg p-4 border-l-4 border-green-400">
                  <h3 className="font-semibold text-green-800 mb-2">Famous Landmarks</h3>
